...
namespace cherrydev
{
    public class AnswerPanel : MonoBehaviour
    {
        ...
        [SerializeField] private Color _selectedColor = Color.gray; // Warna tombol yang pernah dipilih

        private readonly List<Button> _buttons = new();
        private readonly List<TextMeshProUGUI> _buttonTexts = new();
        private readonly HashSet<int> _selectedButtonIndices = new(); // Menyimpan indeks tombol yang pernah dipilih
        ...
        public void SetUpButtons(int maxAmountOfAnswerButtons)
        {
            ...
            for (int i = 0; i < maxAmountOfAnswerButtons; i++)
            {
                ...
                // Set warna tombol berdasarkan apakah pernah dipilih atau tidak
                if (_selectedButtonIndices.Contains(i))
                {
                    answerButton.image.color = _selectedColor;
                }
            }
        }
        ...
        /// <summary>
        /// Returning button text by index
        /// </summary>
        /// <param name="index"></param>
        /// <returns></returns>
